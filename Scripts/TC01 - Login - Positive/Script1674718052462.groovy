...
Mobile.setText(findTestObject('Object Repository/Email_Valid'), 'bob@example.com', 0)

Mobile.setText(findTestObject('Object Repository/Password_Valid'), '10203040', 0)
